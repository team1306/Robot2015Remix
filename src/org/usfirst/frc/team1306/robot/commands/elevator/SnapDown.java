 ...
 *
 */
public class SnapDown extends Command {
    ...
    protected void initialize() {
    	if (RobotMap.elevator.getPoint() > Elevator.Level.TWO.getHeight()) {
    		RobotMap.elevator.goTo(Elevator.Level.THREE);
    	} else if (RobotMap.elevator.getPoint() > Elevator.Level.ONE.getHeight()) {
    		RobotMap.elevator.goTo(Elevator.Level.TWO);
    	} else if (RobotMap.elevator.getPoint() > Elevator.Level.ZERO.getHeight()) {
